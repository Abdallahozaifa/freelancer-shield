          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div>
              ...
              <div className="relative">
                ...
                <Input type="email" value={user?.email || ''} disabled className="pl-10 bg-gray-50 cursor-not-allowed" />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  {...register('full_name')}
                  className={`pl-10 ${!isEditing ? 'bg-gray-50 cursor-not-allowed' : ''} ${errors.full_name ? 'border-red-500' : ''}`}
                />
              </div>
              {errors.full_name && <p className="mt-1.5 text-sm text-red-600">{errors.full_name.message}</p>}
            </div>
