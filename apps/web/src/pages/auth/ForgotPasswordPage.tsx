        ...
        <div className="flex-1 bg-white px-5 pt-5 relative -mt-2">
          ...
          {isSuccess ? (
            <div className="text-center py-8">
              ...
              <Link
                to="/login"
                className="inline-flex items-center gap-2 text-indigo-600 font-medium text-sm"
              >
                <ArrowLeft className="w-4 h-4" />
                Back to login
              </Link>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    {...register('email')}
                    className={`pl-10 pr-4 py-3 border rounded-xl text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all text-sm ${
                      errors.email
                        ? 'border-red-500 bg-red-50/50 focus:ring-red-500'
                        : 'border-indigo-100 bg-indigo-50/50 focus:bg-white'
                    }`}
                  />
                </div>
              </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-200/50 p-6 sm:p-8">
              {isSuccess ? (
                <div className="text-center py-4">
                  ...
                  <Link
                    to="/login"
                    className="inline-flex items-center gap-2 text-indigo-600 font-medium hover:text-indigo-500 transition-colors"
                  >
                    <ArrowLeft className="w-4 h-4" />
                    Back to login
                  </Link>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          disabled={isSubmitting}
                          {...register('email')}
                          className={`pl-11 h-12 border rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 ${
                            errors.email
                              ? 'border-red-500 bg-red-50/50 focus:ring-red-500'
